  ...
  <div>
    ...
    <div class="landing-page-container">
        ...
        <nav data-role="Header" class="landing-page-navbar">
          ...
          <div class="landing-page-right-side">
            <div class="landing-page-links-container">
              <span class="landing-page-text"><a href="../api/index.php">Home</a></span>
        ...
        <div class="landing-page-hero">
          <div class="landing-page-content-container">
            ...
            <h2 class="Subheading landing-page-subheading">
              Este é um projeto com fins educativos.
            </h2>
            <span class="landing-page-text10">
              <span>Quer aprender quimica?</span>
              <br />
              <span>E exercitar sua matemática?</span>
              <br />
              <span>Clique no botão verde abaixo e venha conferir!</span>
            </span>
            <div class="solid-button-container">
              <a href="#main-section">
                <button class="solid-button-button button Button" style="cursor: pointer">
                  <span>Explore nossas matérias</span>
                </button>
              </a>
            </div>
          </div>
      ...
      <div id="main-section" class="landing-page-main">
          ...
          <div class="place-card-container">
            ...
            <div class="place-card-container1">
              ...
              <span class="place-card-text1">
                <span>
                  Estamos trabalhando entregar o melhor conteúdo para você.
                </span>
              </span>
              <div class="outline-button-container">
                <button class="outline-button-button button Button">
                  <span><a href="#">Conferir</a></span>
                </button>
              </div>
            </div>
          </div>
        ...
        <button class="show-more-button hover-active" onclick="showMoreQui()">
          Mostrar mais
        </button>
        <div class="showMoreQui">
          <div class="place-card-container">
            <img alt="image" src="../images/ponto.gif" class="place-card-image" />
            <div class="place-card-container1">
              <span class="place-card-text"><span>Em desenvolvimento...</span></span>
        ...
        <button class="show-more-button2 hover-active" onclick="showMoreQui()" style="display: none;"> Mostrar
          menos</button>
      </div>
    </div>
  </div>

  <!-- Conteudo de matemática -->

  <div id="main-section" class="landing-page-main">
    <span id="landingmat"></span>
    ...
    <div class="landing-page-cards-container">
      ...
      <div class="place-card-container">
        ...
        <div class="place-card-container1">
          ...
          <span class="place-card-text1">
            <span>
              Estamos trabalhando para entregar o melhor conteúdo para você.
            </span>
          </span>
          <div class="outline-button-container">
            <button class="outline-button-button button Button">
    ...
    <button class="show-more-button-mat1 hover-active" onclick="showMoreMat()"> Mostrar mais</button>

    <div class="showMoreMat">
      <div class="place-card-container">
        <img alt="image" src="../images/ponto.gif" class="place-card-image" />
        <div class="place-card-container1">
          <span class="place-card-text"><span>Em desenvolvimento...</span></span>
    ...
    <button class="show-more-button-mat2 hover-active" onclick="showMoreMat()" style="display: none;"> Mostrar
      menos</button>
  </div>
  </div>
  </div>
  ...
  <div class="landing-page-footer">
    <div class="landing-page-menu">
      ...
      <div class="landing-page-follow-container1">
        <span class="landing-page-text16">Acompanhe</span>
